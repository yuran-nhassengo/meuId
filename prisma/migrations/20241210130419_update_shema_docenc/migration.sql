/*
  ...
  - You are about to drop the column `localizacao` on the `DocumentosEncontrados` table. All the data in the column will be lost.
...
INSERT INTO "new_DocumentosEncontrados" ("codigoDocumento", "contacto", "descricao", "id", "linkImagem", "nome", "nomeDocumento", "status", "tipoDocumento", "usuarioId", "whenCreate", "whenUpdate") SELECT "codigoDocumento", "contacto", "descricao", "id", "linkImagem", "nome", "nomeDocumento", "status", "tipoDocumento", "usuarioId", "whenCreate", "whenUpdate" FROM "DocumentosEncontrados";

/*
  ...
  - Added the required column `codigoDocumento` to the `DocumentosEncontrados` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_DocumentosEncontrados" ("contacto", "descricao", "id", "linkImagem", "localizacao", "nome", "nomeDocumento", "tipoDocumento", "usuarioId", "whenCreate", "whenUpdate") SELECT "contacto", "descricao", "id", "linkImagem", "localizacao", "nome", "nomeDocumento", "tipoDocumento", "usuarioId", "whenCreate", "whenUpdate" FROM "DocumentosEncontrados";
